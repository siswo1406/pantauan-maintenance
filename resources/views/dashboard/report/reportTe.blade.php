            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h3>
                            <i class="cil-description"></i> {{ __('REPORT TE') }}
                            <button type="button" class="btn btn-primary float-lg-right ml-5" onclick="window.history.go(-1)">KEMBALI</button>
                        </h3>
                    </div>
                    <div class="card-body">
                        <form class="row d-flex justify-content-start form-inline" action="{{ route('report.reportTe') }}" method="get" style="margin-top:10px; margin-bottom: 10px">@csrf
