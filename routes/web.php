...
Route::group(['middleware' => ['auth']], function () {
    ...
    // MASTER
        Route::get('/masterTaskWork', 'MasterController@masterTaskWork')->name('master.masterTaskWork');
        Route::post('/masterTaskWork/import', 'MasterController@masterTaskWorkImport')->name('master.masterTaskWork.import');
        Route::resource('master', 'MasterController');
    // MASTER
    // REPORT
        Route::get('/reportCme', 'ReportController@reportCme')->name('report.reportCme');
        Route::get('/reportTe', 'ReportController@reportTe')->name('report.reportTe');
        Route::get('/reportBattery', 'ReportController@reportBattery')->name('report.reportBattery');
